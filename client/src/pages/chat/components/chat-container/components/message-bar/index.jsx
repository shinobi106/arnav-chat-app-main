...
const MessageBar = () => {
  ...
  return (
    <div className="h-[10vh] bg-[#1f1f1f] flex justify-center items-center px-8 gap-6 mb-5">
      ...
      <button
        className="bg-[#0000ff] rounded-md flex items-center justify-center p-5 gap-2 focus:border-none focus:outline-none hover:bg-[#251bda] focus:bg-[#251bda] transition-all duration-300 "
