    ...
    <>
      <TooltipProvider>
        <Tooltip>
          ...
          <TooltipContent className="bg-[#0f0f0f] border-none mb-2 p-3">
      ...
      <Dialog open={newChannelModal} onOpenChange={setNewChannelModal}>
        ...
        <DialogContent className="bg-[#0f0f0f] border-none text-white w-[400px] h-max flex flex-col">
          <DialogHeader>
          ...
          <div>
            <Button
              ...
              className=" w-full bg-blue-700 hover:bg-gray-900 transition-all duration-300"
            >
              Create Chat Room
            </Button>
          </div>
